      ...
      <FlexWrapper>
        <div className="w-1/2 max-md:w-full ">
          <div >
            ...
            <p className="py-2 max-md:text-center">Last updated on September 12, 2023</p>
            <p className="my-4 max-md:text-center">
              Below are our privacy & policy, which outline a lot of goodies.
              it’s our aim to always take of our participant
            </p>
          </div>
          <div className="border-custom-purple bg-award2 border rounded-md p-9 max-md:p-5 max-sm:px-2">
            ...
            <div className="flex justify-center"><Button caption="Read More"/></div>
          </div>
        </div>
