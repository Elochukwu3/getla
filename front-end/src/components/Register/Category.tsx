...
const Category = ()=>{
    ...
    return (
        ...
        <p>Category</p>
        <select defaultValue={""} required id="category" className="w-full block  placeholder:text-zinc-600 p-4 bg-inherit border border-zinc-600 rounded-md outline-none">
          <option
            value={""}
            disabled
            selected
